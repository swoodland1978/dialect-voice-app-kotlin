...
const CLIPS = [
  ...
  { dialect: "irish", kind: "welcome", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "Story, welcome to WhyAI - what's the craic, how can I help ya?" },
  { dialect: "irish", kind: "switch", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "Grand, you're listening to Irish now, sure look." },
  { dialect: "irish", kind: "upsell", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "You're not getting feck all for free, ya eejit! Buy some credit, ya tight article." },
  { dialect: "irish", kind: "goodbye", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "Right so, I'm off now - safe home, sure look." },
  { dialect: "irish", kind: "egg", voiceId: "RlSVB64yXMZJjq67jbB1",
  ...
  { dialect: "irish", kind: "randomegg", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "Blah blah blah blah, you wear your mother's bra!" },
  { dialect: "irish", kind: "applejuggler", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "Whoop, whoop, whoopedy whoopy woopersville!" },
  ...
  { dialect: "irish", kind: "maggotmuncher", voiceId: "RlSVB64yXMZJjq67jbB1",
    text: "An American's fanny is an Englishman's arse, and that's why all their trousers are pants, ya maggot muncher!" },
